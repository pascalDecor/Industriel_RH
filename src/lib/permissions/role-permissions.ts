...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  [UserRole.IT_ENGINEER]: [
    // Ingénieur IT - accès technique à l'API
...
// Permissions par modules/sections
...
// Permissions minimum requises pour accéder à l'admin
...
// Permissions pour les différents niveaux d'accès à l'API
export const API_ACCESS_LEVELS = {
  READ_ONLY: [Permission.API_ACCESS],
  DEVELOPMENT: [Permission.API_ACCESS, Permission.DEV_TOOLS],
  FULL_ACCESS: [Permission.API_ACCESS, Permission.DEV_TOOLS, Permission.DATABASE_ACCESS]
} as const;