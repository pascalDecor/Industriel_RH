        ...
        <div>
            ...
            <Card className="p-5 border-none mb-3 shadow-none flex flex-row justify-between items-start">
                ...
                <div className="flex flex-col items-end justify-between h-full">
                    <div className="flex items-center space-x-2">
                        {hire.state === "pending" && <Button onClick={handleValidate(hire.id)} title="Valider" isLoading={loadingValidate} className="!p-2" variant="success" size="sm">Valider</Button>}
                        {(hire.state === "accepted" || hire.state === "pending") && <Button onClick={handleReject(hire.id)} title="Décliner" isLoading={loadingReject} className="!p-2 !text-slate-700" variant="warning" size="sm">Décliner</Button>}
                    </div>
