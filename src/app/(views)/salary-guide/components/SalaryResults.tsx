...
const SalaryResults: React.FC<SalaryResultsProps> = ({ data, searchParams }) => {
  ...
  const percentileData = [
    { name: 'Low (25%)', value: data.percentile25 },
    { name: 'Median (50%)', value: data.percentile50 },
    { name: 'High (75%)', value: data.percentile75 }
  ];
  ...
  const industryData = [
    { name: 'Finance', value: data.percentile50 * 1.15 },
    { name: 'Technology', value: data.percentile50 * 1.1 },
    { name: 'Healthcare', value: data.percentile50 * 0.95 },
    { name: 'Education', value: data.percentile50 * 0.8 },
    { name: 'Retail', value: data.percentile50 * 0.75 }
  ];
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-blue-900/100 rounded-xl p-4">
            <div className="flex items-center text-primary-600 dark:text-primary-400 mb-2">
              ...
              <span className="font-medium text-blue-400">Salary Range</span>
            </div>
          ...
          <div className="bg-cyan-900/100 rounded-xl p-4">
            <div className="flex items-center text-accent-600 dark:text-accent-400 mb-2">
              ...
              <span className="font-medium text-cyan-400">Median Salary</span>
            </div>
            <p className="text-2xl font-bold text-gray-300 dark:text-gray-200">
          ...
          <div className="bg-green-900/100  rounded-xl p-4">
            <div className="flex items-center text-success-600 dark:text-success-400 mb-2">
              ...
              <span className="font-medium text-green-400">Growth Outlook</span>
            </div>
            <p className="text-2xl font-bold text-gray-300 dark:text-gray-200">
              +3% per year
            </p>
        ...
        <div className="h-80 mb-30">
          <h3 className="font-bold text-gray-300 mb-10 text-2xl  ">Salary Distribution</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="h-60 mb-10">
            <h3 className="font-bold text-2xl text-gray-300 dark:text-gray-300 mb-4">Historical Trend</h3>
            <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="h-60 mb-10">
            <h3 className="font-bold text-2xl text-gray-300 dark:text-gray-300 mb-4">Industry Comparison</h3>
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="text-sm text-gray-500 dark:text-gray-400 text-center">
        * All numbers are rounded to the nearest integer. Data last updated: {new Date().toLocaleDateString()}
      </div>
    </div>
  );
};
