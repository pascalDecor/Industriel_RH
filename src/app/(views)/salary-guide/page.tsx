    ...
    <section className="mx-auto max-w-5xl mb-10 p-10">
      <div className="grid grid-cols-5 items-center gap-4 mt-10">
        <div className="lg:col-span-3 col-span-12  pr-4">
          <Image src={imagePathFinder.salaryIQ} className="h-8 w-auto" alt="Salary Net" />
          <h2 className="text-3xl font-semibold text mb-5 text-gray-800">
            {"Discover Your Value"}
          </h2>
          <p className="text-gray-500 text-sm mb-5">
            {`AI-powered salary insights to help you negotiate with confidence and make informed career decisions.`}
          </p>
        </div>
        <div className="lg:col-span-2 col-span-12">
          <Image src={imagePathFinder.salary_guide_page} alt="Salary Guide" />
        </div>
      </div>
    </section>
