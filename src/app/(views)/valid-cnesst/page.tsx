      ...
      <section className="mx-auto max-w-5xl mb-10 p-10">
        <div className="grid grid-cols-5 items-center gap-4 mt-10">
          <div className="lg:col-span-3 col-span-12  pr-4">
            <Image src={imagePathFinder.validCNESST} className="h-8 w-auto mb-3" alt="Salary Net" />
            <h2 className="text-3xl font-semibold text mb-5 text-gray-800">
              {"Validate Employment Documents with Confidence"}
            </h2>
            <p className="text-gray-500 text-sm mb-5">
              {`Ensure your employment documents meet CNESST compliance standards before onboarding.
    Our CNESST Compliance Validator allows HR professionals to verify that every contract or job confirmation meets the legal and regulatory standards in Quebec.`}
            </p>
          </div>
          <div className="lg:col-span-2 col-span-12">
            <Image src={imagePathFinder.valid_cnesst} alt="Salary Guide" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-6 w-full ">
            <div className="col-span-3">
              ...
              <div className="grid grid-cols-4 mb-4">
                {sector && sector?.functions.map(f => <div key={f.id} className="col-span-2">
