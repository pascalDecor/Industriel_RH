...
export default function ArticleDetailPage() {
  ...
  const shareDescription = article?.tags.map(tag => tag.libelle).join(', ') || '';
      ...
      <div className="max-w-7xl mx-auto px-10 py-8 pt-20">
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-6">
            ...
            {article.author && (
              <span className="uppercase text-blue-700 font-bold">• Par  {article.author.name}</span>
            )}
          </div>
        ...
        <div className="flex items-center justify-between mb-6 p-4 bg-white rounded-lg shadow-sm">
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-3 py-1.5 text-sm transition-all duration-200 rounded-md ${
              linkCopied 
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sticky top-24">
              ...
              {loadingRelated ? (
                ...
                <div className="text-center text-gray-500 py-8">
                  <p className="text-sm">Aucun article similaire trouvé</p>
                </div>
              )}
